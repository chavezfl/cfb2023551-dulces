                ...
                <div class="card">
                    <div class="card-header text-light" style="background-color: #032830; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="float-right">
                            <a class="btn btn-outline-light btn-md" href="<?php echo e(route('products.index')); ?>"> <?php echo e(__('Atrás')); ?></a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tienda\resources\views/products/show.blade.php ENDPATH**/ ?>