...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: #032830">
            <div class="container">
                    ...
                    <ul class="navbar-nav me-auto">
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(Auth::user()->role_id == 2): ?>
                                <li class="nav-item">
                                    <a class="nav-link text-light" href="<?php echo e(route('products.index')); ?>"><?php echo e(__('Productos')); ?></a>
                                </li>
                            <?php endif; ?>
                            <li class="nav-item">
                                <a class="nav-link text-light" href="<?php echo e(route('order.create')); ?>"><?php echo e(__('Pedidos')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
